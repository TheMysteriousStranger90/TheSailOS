...
public class CommandProcessor
{
    ...
    private List<string> _availableCommands = new List<string>
    {
        ...
        "httpget", "nettest", "memory", "freespace", "fstype", "log", "login", "createuser", "deleteuser", "listusers",
        "useradmin", "userinfo",
        "changepassword", "changeusername",
        "logout",
        "netshutdown", "netconfig", "tcpserver", "tcpclient", "udpserver", "udpclient",
    ...
    )
    {
        ...
        _commands = new Dictionary<string, ICommand>
        {
            ...
            { "dns", new DnsCommand() },
            { "nettest", new NetworkTestCommand() },
    ...
    private Dictionary<string, string> GetHelpTexts()
    {
        return new Dictionary<string, string>
        {
            ...
            { "nettest", "Tests network connectivity.\nUsage: nettest <ip_address>" },
